        ...
        foreach ($harvest as $item) {
            ...
            foreach ($quantity as $key => $value) {
                ...
                $fairFinancial->separation =
                    ($product->percentage->separation / 100) *
                    $product->price *
                    $value;
                $fairFinancial->fund =
                    ($product->percentage->fund / 100) *
                    $product->price *
                    $value;
                $fairFinancial->payments_transfer =
                    ($product->percentage->payments_transfer / 100) *
                    $product->price *
                    $value;
                $fairFinancial->accounting_close =
                    ($product->percentage->accounting_close / 100) *
                    $product->price *
                    $value;
                $fairFinancial->client_contact =
                    ($product->percentage->client_contact / 100) *
                    $product->price *
                    $value;
                $fairFinancial->payment_conference =
                    ($product->percentage->payment_conference / 100) *
                    $product->price *
                    $value;
